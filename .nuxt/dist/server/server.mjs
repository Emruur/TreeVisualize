import require$$0, { getCurrentInstance, reactive, toRef, isRef, defineComponent, computed, h, resolveComponent, watchEffect, ref, markRaw, onUnmounted, useSSRContext, mergeProps, withCtx, createTextVNode, toDisplayString as toDisplayString$1, unref, onErrorCaptured, onUpdated, createApp } from "vue";
import { withBase, withQuery, joinURL, hasProtocol, parseQuery, isEqual, parseURL } from "ufo";
...
const useError = () => {
  ...
  return useState("error", () => nuxtApp.ssrContext.error, "$1128484472");
};
...
const components = {};
const _47Users_47emreugur_47Documents_47Dev_47Code_47TreeProject_47TreeNuxt_47_46nuxt_47components_46plugin_46mjs = defineNuxtPlugin((nuxtApp) => {
...
const _47Users_47emreugur_47Documents_47Dev_47Code_47TreeProject_47TreeNuxt_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin = defineNuxtPlugin((nuxtApp) => {
...
const _47Users_47emreugur_47Documents_47Dev_47Code_47TreeProject_47TreeNuxt_47node_modules_47nuxt_47dist_47head_47runtime_47plugin = defineNuxtPlugin((nuxtApp) => {
...
const _47Users_47emreugur_47Documents_47Dev_47Code_47TreeProject_47TreeNuxt_47node_modules_47nuxt_47dist_47app_47plugins_47router = defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  preload,
  _47Users_47emreugur_47Documents_47Dev_47Code_47TreeProject_47TreeNuxt_47_46nuxt_47components_46plugin_46mjs,
  _47Users_47emreugur_47Documents_47Dev_47Code_47TreeProject_47TreeNuxt_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin,
  _47Users_47emreugur_47Documents_47Dev_47Code_47TreeProject_47TreeNuxt_47node_modules_47nuxt_47dist_47head_47runtime_47plugin,
  _47Users_47emreugur_47Documents_47Dev_47Code_47TreeProject_47TreeNuxt_47node_modules_47nuxt_47dist_47app_47plugins_47router
];
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-227f42e8><div class="fixed left-0 right-0 spotlight z-10" data-v-227f42e8></div><div class="max-w-520px text-center z-20" data-v-227f42e8><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-227f42e8>${ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-227f42e8>${ssrInterpolate(__props.description)}</p><div class="w-full flex items-center justify-center" data-v-227f42e8>`);
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-5fe03afb><div class="fixed -bottom-1/2 left-0 right-0 h-1/2 spotlight" data-v-5fe03afb></div><div class="max-w-520px text-center" data-v-5fe03afb><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-5fe03afb>${ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-5fe03afb>${ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white px-10 pt-14 dark:bg-black text-black dark:text-white min-h-screen flex flex-col" }, _attrs))} data-v-16c83293><div class="fixed left-0 right-0 spotlight" data-v-16c83293></div><h1 class="text-6xl sm:text-8xl font-medium mb-6" data-v-16c83293>${ssrInterpolate(__props.statusCode)}</h1><p class="text-xl sm:text-2xl font-light mb-8 leading-tight" data-v-16c83293>${ssrInterpolate(__props.description)}</p><div class="bg-white rounded-t-md bg-black/5 dark:bg-white/10 flex-1 overflow-y-auto h-auto" data-v-16c83293><pre class="text-xl font-light leading-tight z-10 p-8" data-v-16c83293>${__props.stack}</pre></div></div>`);
    };
  }
};
...
class AvlTree {
  ...
  drawTreeHelper(node, pos, radius, height, ctx) {
    if (!node)
      return;
  ...
  _delete(key, root) {
    ...
    const balanceState = this._getBalanceState(root);
    if (balanceState === 4) {
      if (this._getBalanceState(root.left) === 2 || this._getBalanceState(root.left) === 3) {
        return root.rotateRight();
      }
      root.left = root.left.rotateLeft();
      return root.rotateRight();
    ...
    if (balanceState === 0) {
      if (this._getBalanceState(root.right) === 2 || this._getBalanceState(root.right) === 1) {
        return root.rotateLeft();
      }
      root.right = root.right.rotateRight();
      return root.rotateLeft();
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><div class="input-bar"><div class="zoom-container"><svg xmlns="http://www.w3.org/2000/svg" class="refresh menu-btn" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg></div><form><button class="input-btn">-</button><input${ssrRenderAttr("value", inputData.value)} type="text" placeholder="enter here..."><button class="input-btn">+</button></form><div class="zoom-container"><svg class="menu-btn zoom" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM13 10H7"></path></svg><svg class="menu-btn zoom" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7"></path></svg></div></div><canvas${ssrRenderAttr("width", unref(width))}${ssrRenderAttr("height", unref(height))}></canvas></div>`);
    };
  }
});
